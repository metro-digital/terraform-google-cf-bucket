...
| storage_admins | list of users with role roles/storage.admin on project level | `list(string)` | `[]` | no |
| storage_class | Bucket's Storage Class | `string` | `"REGIONAL"` | no |
| storage_object_admins | list of users with role roles/storage.objectAdmin on project level | `list(string)` | `[]` | no |
| storage_object_creators | list of users with role roles/storage.objectCreator on project level | `list(string)` | `[]` | no |
| storage_object_viewers | list of users with role roles/storage.objectViewer on project level | `list(string)` | `[]` | no |
